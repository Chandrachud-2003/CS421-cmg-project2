...
def main():
    ...
    with open('/Users/chandrachudgowda/Library/Mobile Documents/com~apple~CloudDocs/Colby/Spring 2023/CS421/Projects/Project 2/CS421-cmg-project2/Namesake-main/letter_lexicon.pickle', 'rb') as handle:
        lexicon = pickle.load(handle)

    # set up Python2vec model
    df = pd.read_json('/Users/chandrachudgowda/Library/Mobile Documents/com~apple~CloudDocs/Colby/Spring 2023/CS421/Projects/Project 2/CS421-cmg-project2/Namesake-main/blog_model.json')
